...
def main(argv: list[str] | None = None) -> int:
    parse_no_args("Fetch the pre-baked BPASS coeval-population SSP cube.", argv)
    return run(
        RELEASE_TAG,
        _ASSETS,
        what="pre-baked BPASS population cube",
        dest_root=BPASS_DATA_DIR,
        citation="Cite Eldridge et al. 2017 (PASA 34, e058) + Stanway & Eldridge 2018 "
