...
| Row-height pairing in the two-column layout | idea | Short beside tall (Readout ↔ Controls, Spectrum ↔ SED); three options, screenshot each. **Worth more now:** V1b raised the Controls floor by 222 px, so the pairing wastes more than it did when this was written. | `visual-performance.md` V2 |
